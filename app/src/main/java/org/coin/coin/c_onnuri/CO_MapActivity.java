...
public class CO_MapActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storeDAO.OnnurimarketData();
        stores = StoreDAO.getOnnurimarket();

        setContentView(R.layout.activity_co_map);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (stores != null) {
            for (Store store : stores) {
                ...
                markerOptions.position(addstore).title(store.getMarket_name());
