...
public class I_WebActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabs.addTab(tabs.newTab().setText("노원"));
        tabs.addTab(tabs.newTab().setText("모아"));
        tabs.addTab(tabs.newTab().setText("온누리"));
        tabs.addTab(tabs.newTab().setText("평화"));
        tabs.addTab(tabs.newTab().setText("통인"));
        ...
        final I_PagerAdapter i_PagerAdapter = new I_PagerAdapter(getSupportFragmentManager(), 5);
        viewPager.setAdapter(i_PagerAdapter);
